...
namespace NewLife.Hive2
{
    ...
    public partial class TCancelDelegationTokenResp : TBase
    {
        ...
        public TCancelDelegationTokenResp(TStatus status) : this()
        {
            Status = status;
        }
        ...
        {
            var struc = new TStruct("TCancelDelegationTokenResp");
        ...
        {
            var sb = new StringBuilder("TCancelDelegationTokenResp(");
            sb.Append("Status: ");
